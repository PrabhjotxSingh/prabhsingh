...
<meta name="description" content="View the Saab calendar.">
<meta name="author" content="Prabhjot Singh">
<title>Calendar - Saab - Lakota West</title>
...
<body style="background-color: #1a1a1a; color: white;">
  ...
  <div class="menubar">
    <a href="members.php" class="links">BACK</a>
  </div>
  
  
  <div class="textareaholder">
    <center>
    <?php echo file_get_contents("https://pastebin.com/raw/2z8ws5em"); ?>
  </center>
